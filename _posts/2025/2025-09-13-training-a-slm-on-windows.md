---
layout: post
title: "fine-tuning a Phi3.5 SLM on Windows via WSL"
...
* run 5 was gonna take an estimated 1000 hours, which is like 41 days (all: n-grams for n=1,2,3)
* run 6 was gonna take 240 hours, which is 10 days (medium: 20% sampline of the n-grams)
* run 7 is estimated to take 20ish hours LOL yay! (lite: no n-grams rofl. 12,299 pairs of training data (the other 20% are validation pairs), filesize 8.4MB)
